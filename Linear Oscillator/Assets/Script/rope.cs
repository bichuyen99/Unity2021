...
public class rope : MonoBehaviour
{
    ...
    void Start()
    {
        A = 0.5f * Mathf.Sqrt(Mathf.Pow(x_0,2) + Mathf.Pow(v,2)/Mathf.Pow(k,2));
		...
		if (v > 0.0001)
            ...
            alpha = x_0;
        transform.position = new Vector3(Mathf.Sin(alpha) * A, 1.5f, 0);
    }
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(Mathf.Sin(betta) * A, 1.5f, 0);
    }
}
